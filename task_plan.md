...
| R-8 | `release` v1.0 与 v1.1 各一份 | 判据 C | `reports/retail_ops/v1/r6/formal-release-006{,-v11}` |
...
- [ ] 1. 预注册（本文件）提交
- [ ] 2. `dataset_version` 可区分两份 OOD v2 素材（TDD）
- [ ] 3. 生成 `phrasing-bank-003` + 构建 OOD v2.2 sealed + 互斥性经验验证
- [ ] 4. R-1 换 seed 重训
- [ ] 5. R-2 dev 60 配对评测
- [ ] 6. R-3/R-4/R-5 OOD v2.2 sealed 三次运行（该分片只此一次）
- [ ] 7. R-6/R-7/R-8 第六次封存 holdout 观测 + 两套 release 判定
- [ ] 8. 证据同步回本地 + 逐产物校验 + 篡改测试
- [ ] 9. 台账、文档、`PROJECT_LOG` 按判读规则落地
- [ ] 10. 第五轮独立审核并签字
