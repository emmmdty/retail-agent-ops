...
from veritool_rl.agent.qwen import GenerationBackend, HardwareProvider, verify_local_model_files
...
from veritool_rl.retail_ops.formal_manifests import FormalTaskManifest
...
def load_candidate_run_evidence(
    ...
    from veritool_rl.retail_ops.base_evaluation import _content_id, _verify_artifact_hashes
