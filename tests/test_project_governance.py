...
_MUST_BE_CAUGHT = (
    ...
    "封存 holdout 的观测总数为 7。",
    "封存 holdout 已消耗七次观测。",
    "整个开发期封存 holdout 只被观测了七次。",
    "The sealed holdout has been observed seven times.",
    "封存 holdout 的观测次数为 7。",
    "一共经历了 7 轮封存 holdout 观测。",
    "共观测过 7 回封存 holdout。",
    "封存 holdout 观测数：7。",
    "封存 holdout 观测总计七次。",
    "封存 holdout 的观测预算 7 次已全部用完。",
    "封存 holdout 观测计数器现在停在 7。",
    "对封存 holdout 发起了 7 组观测。",
    "封存 holdout 观测记录一共 7 条。",
    "There have been seven sealed holdout observations in total.",
    "A total of 7 sealed holdout observations are on record.",
    "The sealed holdout observation count stands at 7.",
    "Seven release decisions have been made on the sealed holdout.",
    "The number of sealed holdout observations is seven.",
)
