...
_MUST_BE_CAUGHT = (
    ...
    "封存 holdout 的观测总数为 8。",
    "封存 holdout 已消耗八次观测。",
    "整个开发期封存 holdout 只被观测了八次。",
    "The sealed holdout has been observed eight times.",
    "封存 holdout 的观测次数为 8。",
    "一共经历了 8 轮封存 holdout 观测。",
    "共观测过 8 回封存 holdout。",
    "封存 holdout 观测数：8。",
    "封存 holdout 观测总计八次。",
    "封存 holdout 的观测预算 8 次已全部用完。",
    "封存 holdout 观测计数器现在停在 8。",
    "对封存 holdout 发起了 8 组观测。",
    "封存 holdout 观测记录一共 8 条。",
    "There have been eight sealed holdout observations in total.",
    "A total of 8 sealed holdout observations are on record.",
    "The sealed holdout observation count stands at 8.",
    "Eight release decisions have been made on the sealed holdout.",
    "The number of sealed holdout observations is eight.",
)
