...
**当前已验证 SFT 对照（2026-07-16）**：从相同四类共 1000 条 BFCL V4 公开
任务中排除固定 holdout 200 条，以稳定哈希划分 720 train / 80 dev；800 个
target 均通过固定官方 AST checker。Qwen3-1.7B 单次 QLoRA-SFT 后在相同
holdout 上为 0.835（167/200），相对 Base 改善/退化/不变为 20/16/164，
success delta +0.020，seed 0、10,000 次配对 bootstrap 95% CI 为
[-0.040, 0.080]。分类 delta 为 +0.08 / +0.04 / +0.04 / -0.08。置信区间跨
0，且 `parallel_multiple` 退化；不能声称稳定改善。这是项目定义的 BFCL V4
